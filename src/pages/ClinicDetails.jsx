...
export default function ClinicDetails() {
  ...
  const handleViewOnMap = () => {
    ...
    navigate(`/map?lat=${lat}&lng=${lon}&zoom=17`);
  };
  ...
  return (
    <div className="page">
      ...
      <p>
        <strong>Address:</strong> {clinic.properties.address}
      </p>
      <p>
        <strong>Tier:</strong> {clinic.properties.tier}
      </p>
      <p>
        <strong>Postal Code:</strong> {clinic.properties.postalcode}
      </p>
      <p>
        <strong>Telephone:</strong> {clinic.properties.telephone}
      </p>
      <button
